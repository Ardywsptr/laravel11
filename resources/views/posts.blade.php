<x-layout>
  <x-slot:title>{{ $title }}</x-slot:title>
    <form class="max-w-md mx-auto" action="/posts" method="GET">   
        ...
        <div class="relative">
            ...
            <input name="search" type="search" id="search" class="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-lg ps-10 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search title..." autocomplete="off" required />
